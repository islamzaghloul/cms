...
$query="select * from comments where comment_post_id={$idd}";               
    ...
    while($row=mysqli_fetch_assoc($posts))               
     {
        ...
        echo "<td><a href='postcomment.php?delete= {$comment_id}'>delete</a></td>"; 
        echo "<td><a href='postcomment.php?approve= {$comment_id}'>approve</a></td>";  
        
    echo "<td><a href='postcomment.php?unapprove={$comment_id}'>unapprove</a></td>";  
